...
Invoke-WebRequest -Uri 'https://www.nuget.org/api/v2/package/Microsoft.UI.Xaml/2.8.6' -OutFile 'Microsoft.UI.Xaml.v2.8.6.zip' -UseBasicParsing
Expand-Archive -LiteralPath 'Microsoft.UI.Xaml.v2.8.6.zip' -DestinationPath 'Microsoft.UI.Xaml.v2.8.6' -Force
Add-AppxPackage -Path '.\Microsoft.UI.Xaml.v2.8.6\tools\AppX\x64\Release\Microsoft.UI.Xaml.2.8.appx' -Verbose
...
$WingetLatestRelease = $WingetReleases.Where{-not $_.draft -and $_.prerelease}[0]
...
Remove-Item -Force -LiteralPath @(
    'Microsoft.UI.Xaml.v2.8.6.zip',
    'Microsoft.VCLibs.x64.14.00.Desktop.appx',
    ($WingetMsixBundle.name),
    ($WingetLicense.name)
) -ErrorAction SilentlyContinue
Remove-Item -Force -Recurse -LiteralPath 'Microsoft.UI.Xaml.v2.8.6' -ErrorAction SilentlyContinue
